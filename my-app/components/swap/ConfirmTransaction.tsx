                            ...
                            <div key={index} className="flex items-start gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-2">
                                        <span className="font-medium text-white">{stepStatus.step}</span>
                                        {stepStatus.status === 'in-progress' && (
                                    ...
                                    {stepStatus.error && (
                                        <p className="text-xs text-red-400 mt-1">{stepStatus.error}</p>
                                    )}
                                </div>
                            </div>
                        ))}
                ...
                {!hasStarted && (
                    <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
                        <div className="flex items-center justify-between">
                            <span className="text-sm text-zinc-400">Estimated Total Cost</span>
