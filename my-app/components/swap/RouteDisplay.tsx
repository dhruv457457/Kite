            ...
            <Card>
                ...
                <CardContent>
                    <div className="flex flex-col items-center justify-center py-12">
                        ...
                        <p className="mt-4 text-slate">Analyzing routes across chains...</p>
                    </div>
                </CardContent>
            </Card>
        );
        ...
        return (
            <Card>
                <CardContent className="py-12 text-center">
                    <p className="text-slate">No route data available</p>
                </CardContent>
            </Card>
        );
    }
                ...
                <div className="space-y-6">
                                ...
                                <div key={index}>
                                    ...
                                    <div className="bg-white border border-silver rounded-lg p-4 shadow-soft">
                                        <div className="flex items-start gap-4">
                                            {/* Step Icon */}
                                            <div className="w-10 h-10 rounded-full bg-cyber-yellow/10 border border-cyber-yellow/30 flex items-center justify-center flex-shrink-0">
                                                {isSwapStep(step) && (
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-2 mb-2">
                                                    <span className="text-xs font-medium text-cyber-yellow uppercase">
                                                        {step.type || 'unknown'}
                                                    </span>
                    ...
                    <div className="border-t border-silver pt-4 space-y-3">
                        <div className="flex items-center justify-between text-sm">
                            <span className="text-slate">Total Gas Cost</span>
                        ...
                        <div className="flex items-center justify-between text-sm">
                            <span className="text-slate">Estimated Time</span>
                            <span className="font-medium text-charcoal">
                        ...
                        <div className="flex items-center justify-between text-sm">
                            <span className="text-slate">Slippage Tolerance</span>
                            <span className="font-medium text-charcoal">
                                {slippage}%
                            </span>
                        </div>

                        <div className="bg-cyber-yellow/10 border border-cyber-yellow/30 rounded-lg p-3 mt-4 shadow-soft">
                            <div className="flex items-center justify-between">
                                <span className="text-sm font-medium text-charcoal">You Receive</span>
                    ...
                    {route.tags && route.tags.length > 0 && (
                        <div className="flex gap-2 flex-wrap">
                            {route.tags.map((tag) => (
                                <span
                                    key={tag}
                                    className="px-2 py-1 text-xs font-medium bg-light-grey text-slate border border-silver rounded"
                                >
                                    {tag}
                                </span>
                            ))}
