            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-zinc-800/50 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs text-zinc-500 uppercase">Preferred Chain</span>
                  </div>
                  <p className="text-white font-medium">
                    {formatChainName(profile.preferredChain)}
                  </p>
                </div>
                ...
                <div className="bg-zinc-800/50 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs text-zinc-500 uppercase">Preferred Token</span>
                  </div>
                  <p className="text-white font-medium">{profile.preferredToken}</p>
                </div>
                ...
                <div className="bg-zinc-800/50 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs text-zinc-500 uppercase">Deposit Target</span>
                  </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4">
                <p className="text-sm text-cyan-400">
                  ...
                  <strong>{formatChainName(profile.preferredChain)}</strong> in{' '}
                  <strong>{profile.preferredToken}</strong>.
                </p>
              </div>
            </div>
